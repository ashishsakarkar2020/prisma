 ...
 * 1. /theme/assets/css/main.1630.min.css
 *
...
function roots_scripts() {
  ...
  wp_enqueue_style('main', get_template_directory_uri() . '/assets/css/main.1630.min.css', false, true, 'all');
  ...
  wp_register_script('roots_scripts', get_template_directory_uri() . '/assets/js/scripts.9af6.min.js', array(), null, true);
